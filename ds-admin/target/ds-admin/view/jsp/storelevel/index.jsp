				...
				<div class="box-header">
						...
						<ul class="col-md-12 search-list clearfix">
							<li class="search-item">
								<input class="search-input" id="level" name="level" placeholder="等级名称" type="text">
							</li>
							<li class="search-item">
								<span class="search-btn">查询</span>
							</li>
							<li class="search-item pull-right">
								<a class="btn btn-success" id="add-btn"> <i class="fa fa-plus"></i> 添加店铺等级</a>
							</li>
						</ul>
						</nav>
					</div>
...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		datatype : "json",
		url : _path + '/admin/storelevel/list.html',
		height : 350,
		jsonReader : {
			root : function(obj) {
				return obj.rows;
		...
		colNames : [ '等级名称', '介绍', '产品数量' , '图片数量' , '模板数量' ,'操作' ],
		colModel : [
			{
				name : 'level',
				index : 'level',
...
$('#add-btn').on("click", function(){
	ajaxContent(_path + "/admin/storelevel/modelindex.html");
});

//编辑
function _edit(id) {
	ajaxContent(_path + "/admin/storelevel/modelindex.html?id=" + id);
}

//删除
function _delete(id) {
	layer.confirm('您确定要删除该信息吗?', function(idx){
		appajax(_path + '/admin/storelevel/delete.html', {'id' : id}, function(data) {
			if (data.success) {
