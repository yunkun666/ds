...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
	<div class="page-header pull-left">
        <div class="page-title">团购列表</div>
    </div>
	<ol class="breadcrumb page-breadcrumb">
		<li><i class="fa fa-home"></i>&nbsp;<a href="index.html">主页</a>&nbsp;&nbsp;
			<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
		<li><a href="javascript:void(0);">团购管理</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
		</li>
...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colNames : [ '团购名称', '团购价', '开始时间','结束时间', '已参团' , '参团库存', '操作' ],
		colModel : [
			{
				name : 'name',
				index : 'name',
...
$('#add-btn').on("click", function(){
	ajaxContent(_path + "/admin/groupactivity/modelindex.html");
});

//编辑
function _edit(id) {
	ajaxContent(_path + "/admin/groupactivity/modelindex.html?id=" + id);
}
